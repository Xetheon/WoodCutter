...
public class WoodCutter implements ModInitializer, ClientModInitializer {
	...
	public static final Identifier WOOD_CUT = new Identifier("woodcutter:woodcutter_cut");
	public static SoundEvent WOODCUTTER_CUT = new SoundEvent(WOOD_CUT);
	...
	public void onInitialize() {
		...
		Registry.register(Registry.SOUND_EVENT, WoodCutter.WOOD_CUT, WOODCUTTER_CUT);
	}
